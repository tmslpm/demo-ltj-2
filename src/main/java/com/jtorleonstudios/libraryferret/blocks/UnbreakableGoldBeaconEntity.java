...
public class UnbreakableGoldBeaconEntity extends BlockEntity implements Tickable {
    public UnbreakableGoldBeaconEntity() {
        super(Blocks.UNBREAKABLE_GOLD_BEACON_ENTITY);
    }
