...
public class UnbreakableNetheriteBeaconEntity extends BlockEntity implements Tickable {
    public UnbreakableNetheriteBeaconEntity() {
        super(Blocks.UNBREAKABLE_NETHERITE_BEACON_ENTITY);
    }
